...
def test_spending_by_category() -> None:
    ...
    long_line = 'платежа\\":\\"RUB\\",\\"Кэшбэк\\":\\"\\",'
    long_line2 = '\\"Категория\\":\\"Переводы\\",\\"MCC\\":\\"\\",\\"Описание\\":\\"Линзомат '
    assert spending_by_category(data, "Переводы", "2018-01-10 8:8:8") == (
        '"[{\\"Дата операции\\":\\"01.01.2018 12:49:53\\",\\"Дата '
        'платежа\\":\\"01.01.2018\\",\\"Номер '
        'карты\\":\\"\\",\\"Статус\\":\\"OK\\",\\"Сумма операции\\":-3000.0,\\"Валюта '
        'операции\\":\\"RUB\\",\\"Сумма платежа\\":-3000.0,\\"Валюта '
        f"{long_line}{long_line2}"
        'ТЦ Юность\\",\\"Бонусы (включая кэшбэк)\\":0,\\"Округление на '
        'инвесткопилку\\":0,\\"Сумма операции с округлением\\":3000.0}]"'
    )
